...
urlpatterns = [
    ...
    path("routines/r/<int:pk>", views.RoutineCourseView.as_view(),
         name='routine_course'),

    path("classroom/cr/<int:pk>", views.ClassRoomView.as_view(),
         name='classroom_detail'),
    path("u/assignments/", views.StudentAssignment.as_view(),
         name='student_assignment'),
    path("u/assignments/as/<int:pk>", views.assignment_detail,
